...
int main(int argc, char** argv) {
    ...
    try {
        ...
        auto cli = lyra::cli()
            ...
            | lyra::opt(output[LL_CPU], "file"                )      ["--output-ll"             ]("Compiles the Thorin program to LLVM.")
            | lyra::opt(output[LL_GPU], "file"                )      ["--output-ll-gpu"         ]("Compiles the Thorin program to LLVM.")
